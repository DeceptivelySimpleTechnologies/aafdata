...
public class EntityTypeAttribute {
    ...
    //    int DataSizeOrMaximumLengthInBytesOrCharacters;
    //    int DataPrecision;
    //    int DataScale;
    //    int KeyTypeEntitySubtypeId;
    //    int RelatedEntityTypeId;
    //    int RelatedEntityTypeAttributeId;
    //    int RelatedEntityTypeCardinalityEntitySubtypeId;
    //    String EntitySubtypeGroupKey;
    ...
    //    String RemoteValidationMethodAsAjaxUri;
    //    int IndexEntitySubtypeId;
    //    int UniquenessEntitySubtypeId;
    //    int SensitivityEntitySubtypeId;
    ...
    public EntityTypeAttribute(int id, int entitySubtypeId, String textKey, String localizedName, int generalizedDataTypeEntitySubtypeId, int entityTypeAttributeValueEntitySubtypeId, String defaultValue, int ordinal, boolean isActive, Timestamp createdAtDateTimeUtc, int createdByInformationSystemUserId, Timestamp updatedAtDateTimeUtc, int updatedByInformationSystemUserId, Timestamp deletedAtDateTimeUtc, int deletedByInformationSystemUserId) {
        Id = id;
