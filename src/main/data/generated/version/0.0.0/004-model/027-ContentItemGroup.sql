...
-- DROP TABLE "ContentItemGroup"."ContentItemGroup";

CREATE TABLE "ContentItemGroup"."ContentItemGroup"
(
    "Id" bigint NOT NULL,
    "Uuid" uuid NOT NULL,
    ...
    CONSTRAINT "ContentItemGroup_PK" PRIMARY KEY ("Id"),

    CONSTRAINT "ContentItemGroup_CHK_TextKey" CHECK ("TextKey" ~* '^[a-z0-9-]+$'),

    CONSTRAINT "ContentItemGroup_UQ1_TextKey_DeletedAtDateTimeUtc" UNIQUE ("TextKey", "DeletedAtDateTimeUtc"),
    CONSTRAINT "ContentItemGroup_UQ1_LocalizedName_DeletedAtDateTimeUtc" UNIQUE ("LocalizedName", "DeletedAtDateTimeUtc"),

    CONSTRAINT "ContentItemGroup_FK_EntitySubtypeId" FOREIGN KEY ("EntitySubtypeId") REFERENCES "EntitySubtype"."EntitySubtype"("Id")
)
