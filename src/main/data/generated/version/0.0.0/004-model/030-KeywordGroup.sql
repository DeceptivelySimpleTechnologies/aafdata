...
-- DROP TABLE "KeywordGroup"."KeywordGroup";

CREATE TABLE "KeywordGroup"."KeywordGroup"
(
    "Id" bigint NOT NULL,
    "Uuid" uuid NOT NULL,
    ...
    CONSTRAINT "KeywordGroup_PK" PRIMARY KEY ("Id"),

    CONSTRAINT "KeywordGroup_CHK_TextKey" CHECK ("TextKey" ~* '^[a-z0-9-]+$'),

    CONSTRAINT "KeywordGroup_UQ1_TextKey_DeletedAtDateTimeUtc" UNIQUE ("TextKey", "DeletedAtDateTimeUtc"),
    CONSTRAINT "KeywordGroup_UQ1_LocalizedName_DeletedAtDateTimeUtc" UNIQUE ("LocalizedName", "DeletedAtDateTimeUtc"),

    CONSTRAINT "KeywordGroup_FK_EntitySubtypeId" FOREIGN KEY ("EntitySubtypeId") REFERENCES "EntitySubtype"."EntitySubtype"("Id")
)
