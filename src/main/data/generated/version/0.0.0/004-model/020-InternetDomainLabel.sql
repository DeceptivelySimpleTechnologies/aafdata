...
-- Table: InternetDomainLabel.InternetDomainLabel

-- DROP TABLE "InternetDomainLabel"."InternetDomainLabel";

CREATE TABLE "InternetDomainLabel"."InternetDomainLabel"
(
    "Id" bigint NOT NULL,
    "Uuid" uuid NOT NULL,
    ...
    CONSTRAINT "InternetDomainLabel_PK" PRIMARY KEY ("Id"),

    CONSTRAINT "InternetDomainLabel_CHK_TextKey" CHECK ("TextKey" ~* '^[a-z0-9-]+$'),

    CONSTRAINT "InternetDomainLabel_UQ1_TextKey_DeletedAtDateTimeUtc" UNIQUE ("TextKey", "DeletedAtDateTimeUtc"),
    CONSTRAINT "InternetDomainLabel_UQ1_LocalizedName_DeletedAtDateTimeUtc" UNIQUE ("LocalizedName", "DeletedAtDateTimeUtc"),

    CONSTRAINT "InternetDomainLabel_FK_EntitySubtypeId" FOREIGN KEY ("EntitySubtypeId") REFERENCES "EntitySubtype"."EntitySubtype"("Id")
)
