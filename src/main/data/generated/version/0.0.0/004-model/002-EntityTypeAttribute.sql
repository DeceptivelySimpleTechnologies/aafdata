...
(
    ...
    CONSTRAINT "EntityTypeAttribute_CHK_LocalizedName" CHECK ("LocalizedName" ~* '^[A-Za-z0-9]+$'),
...
CREATE INDEX "EntityTypeAttribute_IDX_SearchVector" ON "EntityTypeAttribute"."EntityTypeAttribute" USING gin("SearchVector");
